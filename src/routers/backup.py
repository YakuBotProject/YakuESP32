...
def descargar_backup_db(
    ...
    db_password = os.getenv("DB_PASSWORD", "%Rgb153427986%")
    ...
    try:
        ...
        print(f"[BACKUP WARNING] pg_dump falló o no está instalado ({e}). Usando fallback SQLAlchemy.")
        ...
        try:
            ...
            raise HTTPException(
                ...
                detail=f"Fallo al generar copia de seguridad: {fallback_err}"
            )
