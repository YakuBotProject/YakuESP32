...
from ..models.models import dispositivos, usuarios, asignaciones_iot, tipos_dispositivo, tipos_componente, componentes
...
def listar_tipos_metrica(
    ...
    from ..models.models import tipos_metrica
...
def liberar_dispositivo_a_stock(
    ...
    from ..models.models import almacenes
...
def calibrar_sensor_remoto(
    ...
    try:
        ...
        from ..models.models import logs_sistema
